...
export const NavBar = () => {
    ...
    return (
        <div id='topNav' className="navbar-container">
            <div id='navbar' className='background-container'>
