...
export const Footer = () => {
    return (
        <div className='footer-container'>
            <div className="container-logo-buttons">


                <div className='logo-footer'>
                    <img src={logo} alt="humanobarberlogo" width={110} />
                    <h3>Humano Barber Chile </h3>
                </div>
                <div className="container-buttons">


                    <div className='reservar-footer' >
                        <a href="https://humanobarberchile.agendapro.com/cl/workflow?local=27344" target='_blank'>Reservar</a>
                    </div>

                    <div className='icons-footer'>
                        <a href="https://web.facebook.com/humanobarberchile" target="_blank">
                        ...
                        <a href="https://www.instagram.com/humanobarberchile/" target="_blank" >
            ...
            <div className='derechos'>
                <p>HUMANO BARBER CHILE TODOS LOS DERECHOS RESERVADOS <span>®</span> </p>
            </div>
